...
<head>
    ...
    <script src="js/errorHandler20210930.js"></script>
    <script src="js/functions20210930.js"></script>
    <script src="js/ajax.functions20210930.js"></script>
    <script src="js/main20211002.js"></script>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 news col-md-offset-3 col-md-6">
                <ul class="news">
                    <li>2021-10-13: Email sending working again</li>
                    <li>2021-09-26: Fanfiction.net is now working again (slowly).</li>
